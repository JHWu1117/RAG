...
class LLMSettings:
    ...
    # Local Transformers-specific optional fields
    ...
    def from_dict(cls, data: dict[str, Any]) -> Settings:
        ...
        settings = cls(
            llm=LLMSettings(
                ...
                load_in_4bit=bool(llm.get("load_in_4bit", False)),
                local_files_only=bool(llm.get("local_files_only", True)),
                device_map=str(llm.get("device_map", "auto")),
                bnb_4bit_quant_type=str(llm.get("bnb_4bit_quant_type", "nf4")),
                bnb_4bit_use_double_quant=bool(
                    llm.get("bnb_4bit_use_double_quant", True)
                ),
                compute_dtype=str(llm.get("compute_dtype", "bfloat16")),
