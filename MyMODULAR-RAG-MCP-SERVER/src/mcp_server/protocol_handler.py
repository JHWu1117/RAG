...
def create_mcp_server(
    ...
    """
    owns_protocol_handler = protocol_handler is None
    ...
    if register_tools and owns_protocol_handler:
    ...
    # MCP SDK 2.x uses constructor-based low-level handler registration.
    server = Server(
        server_name,
