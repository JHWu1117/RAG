...
description: Create or update repository-scoped Codex skills under .agents/skills for this project, including reusable instructions, references, scripts, and packaging validation. Use when the user explicitly asks to build or maintain a project-local skill; do not use for installing global skills or for ordinary project development.
---
...
```bash
python .agents/skills/project-skill-creator/scripts/init_skill.py <skill-name> --path .agents/skills
```
