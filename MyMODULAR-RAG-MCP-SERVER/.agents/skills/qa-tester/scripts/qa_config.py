...
Usage:
    python .agents/skills/qa-tester/scripts/qa_config.py show          # List profiles
    python .agents/skills/qa-tester/scripts/qa_config.py check         # Verify credentials
    python .agents/skills/qa-tester/scripts/qa_config.py apply <name>  # Apply a profile
    python .agents/skills/qa-tester/scripts/qa_config.py restore       # Restore backup
